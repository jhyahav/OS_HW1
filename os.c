...
/* 
	~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~TEST HEADER FILES~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
	IMPORTANT: In order to use test suite 2, use command
		gcc -O3 -Wall -std=c11 os.c pt.c -lm 
	to compile.
	After using test suite 2, MAKE SURE YOUR CODE COMPILES WITHOUT THE -lm FLAG!
	I recommend checking that your code runs on Nova with the unaltered os.c file provided
	with the assignment.
*/
#include <time.h>
#include <math.h>
...
void test_suite_1(void) {
	...
	printf("Overall:  PASSED SUITE 1\n\n");
}

// Functions for suite 2
